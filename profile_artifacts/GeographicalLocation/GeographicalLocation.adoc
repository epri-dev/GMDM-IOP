...
GeographicalLocation.svg[format=svg, align=center]
...
Inheritance path = <<GeographicalLocation-GeometricElement,GeometricElement>> => <<GeographicalLocation-Identity,Identity>>
...
[[GeographicalLocation-GeometricElement]]
==== GeometricElement
