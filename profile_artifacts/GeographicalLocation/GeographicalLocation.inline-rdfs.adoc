...
Inheritance path = <<GeographicalLocation-EquipmentContainer,EquipmentContainer>> => <<GeographicalLocation-ConnectivityNodeContainer,ConnectivityNodeContainer>> => <<GeographicalLocation-PowerSystemResource,PowerSystemResource>> => <<GeographicalLocation-IdentifiedObject,IdentifiedObject>> => <<GeographicalLocation-Identity,Identity>>

ifdef::GeographicalLocation-description-profile[]
This class is tagged in this profile with the 'Description' tag. To refer to the full definition of this class as defined in the profile this one depends on visit <<{GeographicalLocation-description-profile}-Substation,Substation>>.
endif::GeographicalLocation-description-profile[]
...
Inheritance path = <<GeographicalLocation-ConnectivityNodeContainer,ConnectivityNodeContainer>> => <<GeographicalLocation-PowerSystemResource,PowerSystemResource>> => <<GeographicalLocation-IdentifiedObject,IdentifiedObject>> => <<GeographicalLocation-Identity,Identity>>
